...
def create_and_load_bank_data(
    db_name="top_rates.db",
    table_name="banks",
    csv_file="/Users/raksingh/personal/github/top-rates/app/db/banks.csv",
):
    """
...
def create_and_load_bank_products_data(
    db_name="top_rates.db",
    table_name="bank_products",
    csv_file="/Users/raksingh/personal/github/top-rates/app/db/products.csv",
):
    """
    Create a SQLite database and load bank data from CSV.
    Parameters:
